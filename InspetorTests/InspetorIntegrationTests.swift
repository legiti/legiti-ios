...
//  InspetorTests
//
//  Created by Inspetor on 15/07/19.
...
class InspetorIntegrationTests: XCTestCase {
    ...
    func testPassRecovery() {
        ...
        self.setUpTracker()
        if Inspetor.isConfigured() {
            try! Inspetor.sharedInstance.trackPasswordRecovery(passRecoveryEmail: "pass@recovery.com")
        }
    ...
    func testPassReset() {
        ...
        self.setUpTracker()
        if Inspetor.isConfigured() {
            try! Inspetor.sharedInstance.trackPasswordReset(passResetEmail: "pass@recovery.com")
        }
