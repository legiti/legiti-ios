...
class InspetorClient: InspetorClientService {
    ...
    public func trackPasswordRecovery(passRecoveryEmail: String) throws {
        let data = self.createJson(id: passRecoveryEmail, prefix: "pass_recovery", idSufix: "email")
    ...
    public func trackPasswordReset(passResetEmail: String) throws {
        let data = self.createJson(id: passResetEmail, prefix: "pass_recovery", idSufix: "email")
    ...
    private func verifyResource() -> Bool {
        ...
        if (self.inspetorResource == nil) {
            guard let resource = InspetorResource(inspetorConfig: self.inspetorConfig!) else {
                return false
            }
            self.inspetorResource = resource
        }
        return true
    }
